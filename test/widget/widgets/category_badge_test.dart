...
void main() {
  group('CategoryBadge Widget Tests', () {
    ...
    testWidgets('uses custom color when provided in compact mode', (
      WidgetTester tester,
    ) async {
    ...
    testWidgets('uses theme color when no color provided', (
      WidgetTester tester,
    ) async {
    ...
    group('Compact mode', () {
      testWidgets('renders as Container in compact mode', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget(isCompact: true));
      ...
      testWidgets('has smaller icon size in compact mode', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget(isCompact: true));
      ...
      testWidgets('has smaller text size in compact mode', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget(isCompact: true));
      ...
      testWidgets('uses rounded corners in compact mode', (
        WidgetTester tester,
      ) async {
        await tester.pumpWidget(createTestWidget(isCompact: true));
    ...
    testWidgets('displays different icons correctly', (
      ...
      await tester.pumpWidget(
        createTestWidget(categoryName: 'Electronics', icon: Icons.laptop),
      );
    ...
    testWidgets('displays long category names', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(createTestWidget(categoryName: longName));

      expect(find.text(longName), findsOneWidget);
    });

    testWidgets('renders multiple badges independently', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
    ...
    testWidgets('compact mode has correct padding', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget(isCompact: true));
