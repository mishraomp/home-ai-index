...
- **NFR-001**: UI MUST maintain 60 FPS (16ms frame budget) during all interactions
...
- **NFR-004**: All interactive elements MUST have semantic labels for screen readers
- **NFR-005**: Color contrast MUST meet WCAG 2.1 AA standards (4.5:1 for text)
- **NFR-006**: Touch targets MUST be minimum 48x48 logical pixels

**Code Quality** (per Constitution Principle I):
- **NFR-007**: Code coverage MUST be ≥80% for business logic
- **NFR-008**: Zero linting errors (using `flutter_lints` or stricter)
- **NFR-009**: All public APIs MUST have DartDoc documentation

**Responsiveness** (per Constitution Principle V):
- **NFR-010**: Layout MUST adapt to phone, tablet, and desktop screen sizes
- **NFR-011**: Both portrait and landscape orientations MUST be supported
- **NFR-012**: Light and dark themes MUST be consistently implemented
